...
//                 "x-rapidapi-key": "5ff343fe53msha00954a5d5574b2p1a0addjsn8f83d0c1115f"
//             }
//         } );
//     pr.then((res)=>{
//         const pr2 = res.json();
...
list.forEach((obj,idx)=>{
        ...
        newCard.innerHTML = `
        <img src="${obj.videoThumbnails[0].url}" onmouseover="handleHover(event,${idx})" id="thumbnail">
        <div id="details">
        <h5>${obj.author}</h5>
        <h2>${obj.title}</h2>
        </div>
...
const handleHover = (e,idx)=>{
    // e.target.src = dummyData[idx].videoThumbnails[0];
}
